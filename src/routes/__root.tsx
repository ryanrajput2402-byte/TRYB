...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "TRYB is a social travel platform that helps you find travel companions, join group trips, and plan with AI." },
      { property: "og:title", content: "TRYB — Travel together. Discover more." },
      { property: "og:description", content: "TRYB is a social travel platform that helps you find travel companions, join group trips, and plan with AI." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TRYB — Travel together. Discover more." },
      { name: "twitter:description", content: "TRYB is a social travel platform that helps you find travel companions, join group trips, and plan with AI." },
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="text-center">
        ...
        <p className="mt-2 text-muted-foreground">This route doesn't exist yet.</p>
        <a href="/" className="mt-6 inline-block rounded-full bg-primary px-6 py-2 font-semibold text-primary-foreground">Go home</a>
      </div>
    </div>
  );
}
