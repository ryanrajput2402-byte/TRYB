...
function AuthPage() {
  ...
  return (
    <div className="tryb-theme relative min-h-screen overflow-hidden bg-background px-6 py-10">
      <Link to="/" className="relative inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
      ...
      <div className="relative mx-auto mt-10 w-full max-w-md">
        ...
        <button
          ...
          className="mt-8 flex w-full items-center justify-center gap-3 rounded-2xl border border-border bg-card px-4 py-3.5 font-medium text-foreground shadow-soft transition hover:opacity-90 disabled:opacity-50"
        >
